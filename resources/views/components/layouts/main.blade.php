...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <a href="{{ route('news.create') }}" class="btn btn-outline-secondary mx-3">Yaratish</a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info d-flex">
                    @auth
                    <a href="#" class="d-block">{{ auth()->user()->name ?? 'user nomi qoshiladi'}}</a>
                        <form class="d-block" action="{{ route('logout') }}" method="post">
                            @csrf
                            <button class="d-block mx-5 text-primary" type="submit">chiqish</button>
                        </form>
                    @else
                        <a href="{{ route('login') }}" class="btn btn-outline-light mx-3">Kirish</a
                    @endauth
                </div>
            </div>
